...
if __name__ == "__main__":
    ...
    policy, V = policy_iteration(env_line, gamma=0.99)
    ...
    policy_vi, V_vi = value_iteration(env_line, gamma=0.99)
    ...
    policy_sarsa_line, Q_sarsa_line = sarsa(env_line, episodes=5000, alpha=0.1, gamma=0.99, epsilon=0.1)
    afficher_politique(env_line, policy_sarsa_line, "Line World - Sarsa")
    save(Q_sarsa_line, "lineworld_sarsa_Q.pkl")

    policy_ql_line, Q_ql_line = q_learning(env_line, episodes=5000, alpha=0.1, gamma=0.99, epsilon=0.1)
    ...
    policy_vi_grid, V_vi_grid = value_iteration(env, gamma=0.99)
    ...
    policy_sarsa, Q_sarsa = sarsa(env, episodes=5000, alpha=0.1, gamma=0.99, epsilon=0.1)
    afficher_politique(env, policy_sarsa, "Grid World - Sarsa")
    save(Q_sarsa, "gridworld_sarsa_Q.pkl")

    policy_ql, Q_ql = q_learning(env, episodes=5000, alpha=0.1, gamma=0.99, epsilon=0.1)
